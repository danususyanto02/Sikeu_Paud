        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(forgotPassword.this, "Menigirim Form Lupa Password Ke Email Anda.", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(forgotPassword.this, "Gagal, Coba Cek Kembali Email Anda", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
